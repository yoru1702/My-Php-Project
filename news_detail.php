...
<div class="bg"><br><br>
    <div class="container">
        <div class="card" style="border-radius:30px">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="card-img-top"><?php echo "<img src='admin/news/$pic_news' class='rounded img-fluid w-100'>"; ?></div>
                </div>
                <div class="col-sm-6">
                    <div class="card-body">
        ...
        <?php if($_SESSION["valid_user"]!=""){ ?>
            <form action="news_detail2.php" name="form1" method="post">
                <div class="input-group">
                    <input type="text" class="form-control" name="detail_com" id="detail_com" placeholder="แสดงความคิดเห็น...." required>
