<?php
    ...
    $sql="insert into tb_chat values(null,'$id_his','$_SESSION[valid_user]','$day_chat','$time_chat','$detail_chat','1','n','$video_name','$video_mime')";
    $result=mysqli_query($conn,$sql);
    echo "<meta http-equiv='refresh' content='0;url=doc_h.php?id_his=$id_his'>";
?>