<?php
    ...
    $sql="select * from tb_question where type_ques_n='2'";
    $result=mysqli_query($conn,$sql);
?>
<div class="bg"><br><br>
    <div class="container">
        <center><h2><b>แบบประเมินความพึงพอใจต่อการให้บริการของแพทย์</b></h2></center><hr><br>
        <form action="ques_doc2.php" name="form1" method="post">
