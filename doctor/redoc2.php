<?php
    ...
    $sql="select * from tb_ques_n where type_ques_n='2' and status_n='y'";
...
<div class="row">
    <div class="col-lg-12 col-sm-12 col-12">
        <div class="container"><br>
            <center><h2><b>รายงานแบบประเมินความพึงพอใจต่อการให้บริการของแพทย์</b></h2></center><br>
            <!-- <a class="btn btn-primary" href="redoc2.php" targer="_blank">พิมพ์รายงาน</a><br><hr><br> -->
            <a class="btn btn-primary" href="redoc2.php" onclick="window.print()">พิมพ์รายงาน</a><br><hr><br>
            <?php
                if($num==0){
            ...
            <table class="table table holver table-striped">
                ...
                <?php
                    $i=1;
                    $sql1="select * from tb_question where type_ques_n='2'";
