<?php
    ...
    $pic_new_name=$_FILES["pic_new"]["name"];
        $sql1="update tb_pr set name_pr='$name_pr',tel_pr='$tel_pr',url_pr='$url_pr',detail_pr='$detail_pr' where id_pr='$id_pr'";
        ...
        if($pic_new!=""){
            ...
            if($ext==".jpg" or $ext==".png" or $ext==".gif"){
                ...
                echo "<meta http-equiv='refresh' content='1;url=banner.php'>";
            }
        }
        if($result1){
